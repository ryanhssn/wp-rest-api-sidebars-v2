...
/**
 * Plugin Name: WP REST API Sidebars V2
 * Plugin URI: https://github.com/mrpharderwijk/wp-rest-api-sidebars-v2
 * Description: An extension for the WP REST API that exposes endpoints for sidebars and widgets.
 * Author: Martin Pettersson <marnix@littlebigagency.com>
 * Author URI: https://github.com/mrpharderwijk
 * Text Domain: wp-rest-api-sidebars-v2
 * Domain Path: /locale
 * Version: 0.1.1
 * Network: false
 * License: GPLv2
